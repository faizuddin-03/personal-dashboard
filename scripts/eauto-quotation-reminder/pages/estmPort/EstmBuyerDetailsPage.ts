...
/**
 * VERBATIM PORT of `scripts/eauto-estm/pages/BuyerDetailsPage.ts` — see
 * `EstmSession.ts` in this directory for why. Every comment below (including
 * the "do not switch to #buyerEmail" warning, learned the hard way in
 * `scripts/eauto-estm` on 2026-08-18) applies exactly as much here — this is
 * the same fragile, order-dependent stretch, just running under a different
 * `@playwright/test` install.
 */
export class EstmBuyerDetailsPage {
