...
// Ported from scripts/eauto-insurance/pages/BasePage.ts — the campaign-banner
// dismissal logic is identical UCD chrome, so it's copied rather than
// re-derived. See knowledge/flow-ucd-company-listing.md § Traps.
